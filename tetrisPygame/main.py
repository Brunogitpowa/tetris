...
# Convierte la figura en posiciones
...
# Verifica si la figura está en una posición válida
...
# Verifica si alguna figura ha tocado el límite superior
...
# Obtiene una figura aleatoria
def get_shape():
    return Piece(5, 0, random.choice(shapes))

# Dibuja el texto en el medio de la pantalla
...
# Borra las filas completas y devuelve la cantidad de filas eliminadas
...
def main():
    global win  # Añadido para usar la ventana globalmente
    print("Game Started")
    locked_positions = {}
    ...
    while run:
        ...
        pygame.display.update()  # Añadido para actualizar la pantalla
